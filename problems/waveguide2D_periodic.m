...
% in an conducting surface in front of an infinite medium
% 
...
%nonfree_edge_nodes = [top_edge_nodes; bottom_edge_nodes];
nonfree_edge_nodes = zeros(1); % required for periodic BC use! 
...
K = buildKlaplacian(K,triangle_list,node_list,nonfree_edge_nodes);
% Term 2 - Coefficient * Field
K = buildKcoeff(K,triangle_list,node_list,nonfree_edge_nodes,k0);
% Right hand source term
F = buildFsource(F,triangle_list,node_list,nonfree_edge_nodes,source);
